...
def _register_cuda_dll_dirs() -> None:
    ...
    process PATH -- it does not respect os.add_dll_directory(). The
    nvidia-cublas-cu12 / nvidia-cudnn-cu12 pip packages ship the DLLs but
    don't add themselves to PATH, so do both here (add_dll_directory covers
    Python-level ctypes/import loads; PATH covers ctranslate2's own loader)."""
